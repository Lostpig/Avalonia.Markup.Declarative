...
public static class ControlPropertyExtensions
{
    ...
    public static TControl _set<TControl, TValue>(this TControl control, Func<TValue> getter, Action<TControl,TValue> setter, Action<TValue>? changeHandler = null)
    ...
    public static TControl _set<TControl, TValue>(this TControl control, ISignal<TValue> signal, AvaloniaProperty<TValue> avaloniaProperty, Action<TValue>? changeHandler = null)
        where TControl : AvaloniaObject
    {
        var component = ComponentBuildContext.CurrentComponent ?? throw new InvalidOperationException("Current component is not set! ");
    ...
    public static TControl _set<TControl, TValue>(this TControl control, ISignal<TValue> signal, Action<TControl, TValue> setter, Action<TValue>? changeHandler = null)
    where TControl : AvaloniaObject
    {
        var component = ComponentBuildContext.CurrentComponent ?? throw new InvalidOperationException("Current component is not set! ");
    ...
    public static TElement BindClass<TElement>(this TElement control, Signal<bool> signal, string className)
        where TElement : Control
    {

        var component = ComponentBuildContext.CurrentComponent;
    ...
    where TElement : Control
    {
        ...
        component.AddComputedState(state);
