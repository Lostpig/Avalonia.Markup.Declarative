...
public static T Points<T>(this T control, Func<System.Collections.Generic.IList<Avalonia.Point>> func, Action<System.Collections.Generic.IList<Avalonia.Point>>? onChanged = null) where T : Avalonia.Controls.Shapes.Polygon 
   => control._set(func, Avalonia.Controls.Shapes.Polygon.PointsProperty!, onChanged);

/*BindFromSignalSetterGenerator*/
public static T Points<T>(this T control, ISignal<System.Collections.Generic.IList<Avalonia.Point>> signal, Action<System.Collections.Generic.IList<Avalonia.Point>>? onChanged = null) where T : Avalonia.Controls.Shapes.Polygon 
   => control._set(signal, Avalonia.Controls.Shapes.Polygon.PointsProperty!, onChanged);
