...
public static T Data<T>(this T control, Func<Avalonia.Media.Geometry> func, Action<Avalonia.Media.Geometry>? onChanged = null) where T : Avalonia.Controls.PathIcon 
   => control._set(func, Avalonia.Controls.PathIcon.DataProperty!, onChanged);

/*BindFromSignalSetterGenerator*/
public static T Data<T>(this T control, ISignal<Avalonia.Media.Geometry> signal, Action<Avalonia.Media.Geometry>? onChanged = null) where T : Avalonia.Controls.PathIcon 
   => control._set(signal, Avalonia.Controls.PathIcon.DataProperty!, onChanged);
