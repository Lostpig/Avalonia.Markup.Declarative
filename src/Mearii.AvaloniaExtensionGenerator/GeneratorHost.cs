...
using Mearii.AvaloniaExtensionGenerator.Generators.AttachedPropertySetterGenerator;
using Mearii.AvaloniaExtensionGenerator.Generators.EventGenerators;
using Mearii.AvaloniaExtensionGenerator.Generators.SetterGenerators;
using Mearii.AvaloniaExtensionGenerator.Generators.StyleSetterGenerators;

namespace Mearii.AvaloniaExtensionGenerator;
    ...
    private void GenerateExtensions()
    {
        ...
        [
            new("Properties", 
                ...
                new BindFromFuncSetterGenerator(),
                new BindFromSignalSetterGenerator(),
        ...
        foreach (var controlType in config.TypesToProcess)
        {
            ...
            sb.AppendLine($@"[global::System.CodeDom.Compiler.GeneratedCode(""Mearii.AvaloniaExtensionGenerator"", ""{versionString}"")]");
